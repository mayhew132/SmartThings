...
metadata {
	definition (name: "Neato Botvac Connected Series (with Clean Buttons)", namespace: "alyc100", author: "Alex Lee Yuk Cheung", ocfDeviceType: "oic.d.switch", mnmn: "SmartThings", vid: "generic-switch") {
    	capability "Battery"
		capability "Polling"
		capability "Refresh"
		capability "Switch"
